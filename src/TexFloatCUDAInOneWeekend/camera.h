...
__device__ color ray_color(const ray& r, int max_depth, curandState *thread_rand_state,
    ...
    cudaTextureObject_t texObj_materials_albedo_fuzz, cudaTextureObject_t texObj_materials_ri,
